    ...
    return (
        ...
        >
            ...
            <span className='overflow-hidden'>
                <span className='block max-w-0 group-hover:max-w-xs whitespace-nowrap scale-0 group-hover:scale-100 opacity-0 group-hover:opacity-100 group-hover:mr-3 text-sm font-bold tracking-widest uppercase font-heading text-foreground transition-all ease-out duration-500'>
                    Chat with us
                </span>
            </span>
            ...
            <motion.a
                ...
                className='flex items-center justify-center bg-accent text-primary p-3 rounded-full shadow-lg transition-colors duration-300 hover:bg-foreground'
            >
